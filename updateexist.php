...
<HTML>
<HEAD>
<TITLE> Update Existing Competitor </TITLE>
...
//	$sql = "UPDATE competitors SET driver_first = '$txtFirst',driver_middle='$txtMiddle',driver_last='$txtLast',driver_dob='$txtDOB',driver_address='$txtAddress',driver_city='$txtCity',driver_state='$txtState',driver_zip='$txtZip',driver_dl='$txtDL',driver_phone='$txtPhone',driver_email='$txtEmail',owner_first='$txtOwnFirst',owner_middle='$txtOwnMiddle',owner_last='$txtOwnLast',owner_address='$txtOwnAddress',owner_city='$txtOwnCity',owner_state='$txtOwnSt',owner_zip='$txtOwnZip',owner_phone='$txtOwnPhone',sponsor_name='$txtSponsorname',sponsor_address='$txtSponsorAddress',emer_first='$txtEmerFirst',emer_last='$txtEmerLast',emer_address='emeraddress',emer_phone='$txtEmerPhone',emer_relation='EmerRelationupdate',boat_name='$txtBoatname',boat_year='$txtBoatyear',boat_mfg='$txtBoatmfg',boat_hull='$txtBoathull',boat_length='$txtBoatlength',boat_engines='$txtBoatengines',boat_block='$txtBoatblock',boat_cuinch='$txtBoatCuinch',boat_outdrivetype='$txtOutdrive',boat_mods='$txtBoatmods',boat_state='SU' WHERE competitor_id=$competitor";
