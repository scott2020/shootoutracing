...
$sql = "SELECT * from previous_competitors WHERE competitor_id = '$previous_competitorid'";
...
<INPUT TYPE="hidden" NAME="txtClassname" VALUE = <?php echo $classname ?>>
...
<INPUT TYPE="text" SIZE="16" NAME="txtCity" VALUE="<?php echo $driver_city ?>"></td>
  ...
  <tr>
    ...
    <td width="73%"><FONT FACE="Arial" SIZE="2">
<INPUT TYPE="text" SIZE="27" NAME="txtThrottleman" VALUE="<?php echo $driver_address2 ?>"></td>
  </tr>
    <tr>
...
<P><FONT FACE="Arial" SIZE="2"><INPUT TYPE="submit" VALUE="Register" NAME="cmdUpdatereg"></FONT></P>
</form>
<br>
