...
$txtFirst=mysql_real_escape_string($_GET['txtFirst']);
$txtMiddle=mysql_real_escape_string($_GET['txtMiddle']);
$txtLast=mysql_real_escape_string($_GET['txtLast']);
$txtDOB=mysql_real_escape_string($_GET['txtDOB']);
$txtAddress=mysql_real_escape_string($_GET['txtAddress']);
$txtThrottleman=mysql_real_escape_string($_GET['txtThrottleman']);
$txtCity=mysql_real_escape_string($_GET['txtCity']);
$txtState=mysql_real_escape_string($_GET['txtState']);
$txtZip=mysql_real_escape_string($_GET['txtZip']);
$txtDL=mysql_real_escape_string($_GET['txtDL']);
$txtPhone=mysql_real_escape_string($_GET['txtPhone']);
$txtOwnFirst=mysql_real_escape_string($_GET['txtOwnFirst']);
$txtOwnMiddle=mysql_real_escape_string($_GET['txtOwnMiddle']);
$txtOwnLast=mysql_real_escape_string($_GET['txtOwnLast']);
$txtOwnAddress=mysql_real_escape_string($_GET['txtOwnAddress']);
$txtOwnCity=mysql_real_escape_string($_GET['txtOwnCity']);
$txtOwnSt=mysql_real_escape_string($_GET['txtOwnSt']);
$txtOwnZip=mysql_real_escape_string($_GET['txtOwnZip']);
$txtSponsorname=mysql_real_escape_string($_GET['txtSponsorname']);
$txtSponsorAddress=mysql_real_escape_string($_GET['txtSponsorAddress']);
$txtEmerFirst=mysql_real_escape_string($_GET['txtEmerFirst']);
$txtEmerLast=mysql_real_escape_string($_GET['txtEmerLast']);
$txtBoatname=mysql_real_escape_string($_GET['txtBoatname']);
$txtBoatmfg=mysql_real_escape_string($_GET['txtBoatmfg']);
$txtBoathull=mysql_real_escape_string($_GET['txtBoathull']);
$txtBoatengines=mysql_real_escape_string($_GET['txtBoatengines']);
$txtBoatblock=mysql_real_escape_string($_GET['txtBoatblock']);
$txtOutdrive=mysql_real_escape_string($_GET['txtOutdrive']);
$txtBoatmods=mysql_real_escape_string($_GET['txtBoatmods']);
$txtBio=mysql_real_escape_string($_GET['txtBio']);
