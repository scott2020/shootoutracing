...
<TITLE>Shootout Top By Class</TITLE>
</HEAD>

<BODY>

<h2> Top Scores by Class </h2>
...
echo "<table border='1' width='95%'>";
	echo "<tr>";
	echo "<td width='10%'>Class</td><td width='13%'><p align='center'>Speed</td><td width='24%'><p align='center'>Driver</td><td width='5%'><p align='center'>Boat No</td><td width='20%'>Run Time</td><td width='33%'><p align='center'>Owner</td>";
	echo "</tr>";
	echo "</table>";
 ...
 $result2 = mysql_query($sql2); 
   ...
   $num2 = mysql_numrows($result2);
    ...
    while ($j < $num2) {
	   ...
	   echo "<tr>";
	   echo "<td width='10%'>$boat_class</td><td width='13%'><p align='center'>$speed</td><td width='24%'>$driver_first $driver_last</td><td width='5%'><p align='center'>$boat_number</td><td width='20%'>$timeformat</td><td width='33%'>$owner_first $owner_last</td>";
	 echo "</tr>";
